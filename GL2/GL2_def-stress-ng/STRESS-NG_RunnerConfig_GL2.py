...
def get_Rittal_credentials():
    username = os.getenv("RITTAL_U_1")
    password = os.getenv("RITTAL_P_1")
...
class RunnerConfig:
    ...
    def create_run_table_model(self) -> RunTableModel:
        ...
        #factor1 = FactorModel("runs", ['r1'])
        factor2 = FactorModel("workload", ['0', '50', '75', '100'])
